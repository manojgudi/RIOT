...
// Coreconf model generated using the tool in generateCBORDumps.py
...
// Key Mapping {1013: [1015], 1008: [1011]}
const uint8_t keyMappingCBORBuffer[] = {0xa2, 0x19, 0x003, 0xf5, 0x81, 0x19, 0x003, 0xf7, 0x19, 0x003, 0xf0, 0x81, 0x19, 0x003, 0xf3};
